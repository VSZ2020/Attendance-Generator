...
namespace AG.ViewModels.Forms
{
	public class EditEmployeeViewModel: ViewModelCore
	{
		...
		{
			this.FirstName = editedEmployee.FirstName;
			this.LastName = editedEmployee.LastName;
			this.MiddleName = editedEmployee.MiddleName;
			this.Email = editedEmployee.Email;
			this.Phone = editedEmployee.PhoneNumber;
			this.Rate = editedEmployee.Rate;
			this.IsConcurrent = editedEmployee.IsConcurrent;
		...
		{
			base.ShowWaitMessage("Выполняется сохранение", "Пожалуйста, подождите");
